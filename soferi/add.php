...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$nume) {
        ...
        $stmt = $conn->prepare("INSERT INTO soferi (nume, telefon, email, nr_permis, categorie_permis, data_expirare_permis) VALUES (?,?,?,?,?,?)");
        $stmt->bind_param("ssssss", $nume, $telefon, $email, $nr_permis, $categorie_permis, $data_expirare_permis);
        $stmt->execute();
        $stmt->close();
